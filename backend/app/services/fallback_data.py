...
from app.services.image_service import category_fallback_image
...
FALLBACK_SIGNALS: list[SignalResponse] = [
    SignalResponse(
        ...
        published_at=_now(),
        image_url=category_fallback_image("AI Agents"),
    ...
    SignalResponse(
        ...
        published_at=_now(),
        image_url=category_fallback_image("Open Source AI"),
    ...
    SignalResponse(
        ...
        published_at=_now(),
        image_url=category_fallback_image("Developer Tools"),
    ...
    SignalResponse(
        ...
        published_at=_now(),
        image_url=category_fallback_image("Startup and Funding"),
        image_alt="Startup and funding news image",
        summary=SummaryPayload(
    ...
    SignalResponse(
        ...
        published_at=_now(),
        image_url=category_fallback_image("Research Breakthroughs"),
        image_alt="Research breakthroughs news image",
        summary=SummaryPayload(
