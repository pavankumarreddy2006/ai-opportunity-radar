...
INTEREST_KEYWORDS = {
    ...
    "ai tools": {"tool", "tools", "assistant", "agent", "workflow", "automation", "copilot"},
    ...
    "saas": {"saas", "subscription", "b2b", "product", "customers", "mrr"},
    "business ideas": {"startup", "idea", "market", "customer", "opportunity", "business"},
    "side hustles": {"side", "creator", "automation", "income", "nocode", "tool"},
    "machine learning": {"ml", "machine", "learning", "model", "training", "dataset"},
    "prompt engineering": {"prompt", "prompts", "prompting", "agent", "llm"},
    "finance": {"finance", "fintech", "market", "investment", "banking"},
    "crypto": {"crypto", "bitcoin", "ethereum", "web3", "blockchain"},
    "tech news": {"tech", "technology", "ai", "software", "hardware"},
    "productivity": {"productivity", "workflow", "calendar", "notes", "assistant"},
    "youtube automation": {"youtube", "video", "creator", "automation", "content"},
    "content creation": {"content", "creator", "video", "writing", "marketing"},
